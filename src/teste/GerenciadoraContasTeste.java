...
public class GerenciadoraContasTeste {
    ...
    private GerenciadoraContas ger;
    private ContaCorrente c1, c2;

    @Before
    public void setUp() {
        c1 = new ContaCorrente(1, 100.0, true);
        c2 = new ContaCorrente(2, 200.0, false);
        List<ContaCorrente> contas = new ArrayList<>();
        contas.add(c1);
        contas.add(c2);
        ger = new GerenciadoraContas(contas);
    }
    ...
    public void testAdicionaConta() {
        ContaCorrente c3 = new ContaCorrente(3, 300.0, true);
